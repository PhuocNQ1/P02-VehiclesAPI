...
public class CarControllerTest {
    ...
    /**
     * Tests the update a car by ID.
     *
     * @throws Exception if the update a vehicle fails
     */
    @Test
    public void updateCar() throws Exception {
        ...
        mvc.perform(put("/cars/1").content(json.write(car).getJson()).contentType(MediaType.APPLICATION_JSON_UTF8))
                .andExpect(status().isOk())
    ...
    /**
     *
     * @return an example Car object updated
     */
    private Car getUpdateCar() {
        Car car = new Car();
        car.setLocation(new Location(123.123, -321.123));
        Details details = new Details();
        Manufacturer manufacturer = new Manufacturer(111, "Mercedes");
        details.setManufacturer(manufacturer);
        details.setModel("ABC");
        details.setMileage(123123);
        details.setExternalColor("red");
        details.setBody("SUV");
        details.setEngine("10.0L V6");
        details.setFuelType("Diesel");
        details.setModelYear(2023);
        details.setProductionYear(2023);
        details.setNumberOfDoors(8);
        car.setDetails(details);
